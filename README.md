...
I hold an **RNCP Level 7 (Master’s equivalent) diploma in Game Programming** from Isart Digital.  
I am passionate about real-time rendering, systems programming, optimization, and I love sharing what I learn on my [blog](https://renardjojo.github.io/).
...
- **Tools**: Vs, Rider, Vscode, RenderDoc, Pix, Nsight...
- **Shader**: GLSL, HLSL, ShaderLab (unity)
- **Rendering API**: OpenGL ES, OpenGL, DirectX 11/12, Vulkan, Metal
- **Versionning**: Git, SVN, Perforce
- **Platforms**: iOS, android, switch, PS4 and PC
- **Game engine skills**: 
  - Rendering
...
I am currently working at **Ubisoft Paris Mobile** since 2021 as rendering programmer for mobile and pc games. <br />
And before ? I was a **nurse** during 2 years and fireman during 6 years as volonter<br />
